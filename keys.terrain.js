...
module.exports = {
  ...
  bombay: {
    "gorilla cheese unit bicycle label blind dog review sorry indoor airport betray decline sunny shrug gossip cherry roof fire prize now banana dream sleep",
  },
};
